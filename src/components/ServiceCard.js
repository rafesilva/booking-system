    ...
    return (
        ...
        <Card>
          <CardBody>
            ...
            <Button>< Link className="link" to={`/booking/${this.state.service._id}/${this.state.service.name}/${this.state.service.duration}/${this.state.service.price}`}>Book Now</Link> </Button>
          </CardBody>
        </Card>
